...
let isAuthenticated = (req, res, next) => {
  ...
  if (req.params.uId || req.query.uId || req.body.uId || req.header('uId')) {
    Auth.findOne({authToken: req.header('uId') || req.params.uId || req.body.uId || req.query.uId}, (err, authDetails) => {
      if (err) {
        console.log(err)
